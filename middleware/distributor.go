...
func Distribute() func(c *gin.Context) {
	return func(c *gin.Context) {
		...
		if _, isAuto := c.Get("auto_original_model"); isAuto && channel != nil {
			common.SysLog(fmt.Sprintf("[AUTO] channel=%s(id=%d) model=%s", channel.Name, channel.Id, modelRequest.Model))
		}
		c.Next()
